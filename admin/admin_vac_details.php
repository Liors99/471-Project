...
<div class="container center">
    ...
    <?php if($res): ?>
        ...
        <h4> Type: Vacation </h4>
        <h4> Start Date: <?php echo $res[0]["start_date"]?></h4>
        <h4> End Date: <?php echo $res[0]["end_date"]?></h4>
        ...
        <form class ="blue lighten-5" action="admin_vac_details.php?id=<?php echo $emp_id?>&startDate= <?php echo $emp_start_date?> " method="POST">
            <div class="center">
